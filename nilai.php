...
<div style="margin-left: 310px; width: calc(100% - 350px);">
  <br>
    <h1>DAFTAR NILAI</h1><hr>

    
<br>

    <a href="tambahNilai.php" class="btn btn-primary mr-3 mt-4"><i class= "fas fa-plus mr-2"></i></i>Tambah Data</a>
  ...
  <tbody>
    ...
    while ($row = mysqli_fetch_assoc($result)): ?>
      ...
      <td><?php echo $row['nilai']; ?></td>
          ...
          <td><a href="edit2Nilai.php?id=<?= $row["id"]; ?>"><i class="fas fa-edit bg-warning p-2 text-white rounded "></i></a></td>
         <td><a href="deleteNilai.php?id=<?= $row["id"]; ?>"><i class="fas fa-trash bg-danger p-2 text-white rounded" ></i></a></td>
        </tr>
   <?php endwhile; ?>
