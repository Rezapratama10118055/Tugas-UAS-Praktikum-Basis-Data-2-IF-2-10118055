    ...
    while ($row = mysqli_fetch_assoc($result)): ?>
      ...
      <td><?php echo $row['jenis_kelamin']; ?></td>
       <td><?php echo $row['alamat']; ?></td>
          ...
          <td><a href="edit2.php?id=<?= $row["id"]; ?>"><i class="fas fa-edit bg-warning p-2 text-white rounded "></i></a></td>
         <td><a href="delete.php?id=<?= $row["id"]; ?>"><i class="fas fa-trash bg-danger p-2 text-white rounded" ></i></a></td>
        </tr>
   <?php endwhile; ?>
