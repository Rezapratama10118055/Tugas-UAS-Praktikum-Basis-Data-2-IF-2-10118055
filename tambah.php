	...
	<div class="container" style="margin-top:20px">
		...
		if(isset($_POST['submit'])){
			...
			if(mysqli_num_rows($cek) == 0){
				$sql = mysqli_query($koneksi, "INSERT INTO mahasiswa(nim, nama, tanggal_lahir,jenis_kelamin, alamat) VALUES('$nim', '$nama','$tanggal_lahir' ,'$jenis_kelamin', '$alamat')") or die(mysqli_error($koneksi));
