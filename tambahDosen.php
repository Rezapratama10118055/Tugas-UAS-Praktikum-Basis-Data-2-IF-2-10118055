		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav mr-auto">
					<li class="nav-item">
						<a class="nav-link" href="dosen.php">Home</a>
					</li>
	...
	<div class="container" style="margin-top:20px">
		...
		if(isset($_POST['submit'])){
			...
			if(mysqli_num_rows($cek) == 0){
				$sql = mysqli_query($koneksi, "INSERT INTO dosen(nip, nama_dosen, tanggal_lahir,dosen_matkul,alamat) VALUES('$nip', '$nama_dosen','$tanggal_lahir' ,'$dosen_matkul','$alamat')") or die(mysqli_error($koneksi));
		...
		<form action="tambahDosen.php" method="post">
			...
			<div class="form-group row">
				<label class="col-sm-2 col-form-label">Dosen Matakuliah</label>
				<div class="col-sm-10">
