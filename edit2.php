...
<body>
	...
	<div class="container" style="margin-top:20px">
		...
		if(isset($_POST['submit'])){
			...
			$sql = mysqli_query($koneksi, "UPDATE mahasiswa SET nama='$nama', tanggal_lahir='$tanggal_lahir', alamat='$alamat' WHERE id='$id'") or die(mysqli_error($koneksi));
			
			if($sql){
				echo '<script>alert("Berhasil menyimpan data."); document.location="edit2.php?id='.$id.'";</script>';
			}else{
		...
		<form action="edit2.php?id=<?php echo $id; ?>" method="post">
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					...
					<a href="daftarmahasiswa.php" class="btn btn-warning">KEMBALI</a>
				</div>
			</div>
		</form>
