...
<div style="margin-left: 310px; width: calc(100% - 350px);">
  <br>
    <h1>DAFTAR MATAKULIAH</h1><hr>

  

    <a href="tambahMatkul.php" class="btn btn-primary mr-3 mt-4"><i class= "fas fa-plus mr-2"></i></i>Tambah Data</a>
    ...
    <tr>
      ...
      <th scope="col">Kode Matakuliah</th>
       ...
       <th scope="col">Semester</th>
        <th scope="col">Dosen Matakuliah</th>
  ...
  <tbody>
    ...
    while ($row = mysqli_fetch_assoc($result1)): ?>
      ...
      <td><?php echo $row['id_kelas']; ?></td>
                  <td><a href="edit2Matkul.php?idmatkul=<?= $row["idmatkul"]; ?>"><i class="fas fa-edit bg-warning p-2 text-white rounded "></i></a></td>
         <td><a href="deleteMatkul.php?idmatkul=<?= $row["idmatkul"]; ?>"><i class="fas fa-trash bg-danger p-2 text-white rounded"></i></a></td>
        </tr>
   <?php endwhile; ?>
